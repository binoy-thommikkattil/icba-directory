...
export const families = {
  active: {
    ...
    status: 'Active',
    primaryMobile: '+91 9876543200',
    primaryCallCountryCode: '+91',
    primaryCallPhone: '9876543200',
    primaryWhatsAppCountryCode: '+91',
    primaryWhatsAppPhone: '9876543205',
    ...
    members: [
      {
        name: 'John Doe',
        callCountryCode: '+91',
        callPhone: '9876543200',
        whatsappCountryCode: '+91',
        whatsappPhone: '9876543205',
        relationship: 'Head',
        bloodGroup: 'O+',
      ...
      },
      {
        name: 'Jane Doe',
        callCountryCode: '+91',
        callPhone: '9876543201',
        whatsappCountryCode: '+91',
        whatsappPhone: '9876543201',
        relationship: 'Wife',
        bloodGroup: 'A+',
  ...
  inactive: {
    ...
    status: 'Inactive',
    primaryMobile: '+91 9876543299',
    primaryCallCountryCode: '+91',
    primaryCallPhone: '9876543299',
    primaryWhatsAppCountryCode: '+91',
    primaryWhatsAppPhone: '9876543299',
    members: [{ name: 'Inactive Member', callCountryCode: '+91', callPhone: '9876543299', whatsappCountryCode: '+91', whatsappPhone: '9876543299', tags: [] }],
    isPendingCreation: false,
    hasPendingEdit: false,
    draftData: null,
  ...
  pendingCreation: {
    ...
    status: 'Active',
    primaryMobile: '+91 9876500000',
    primaryCallCountryCode: '+91',
    primaryCallPhone: '9876500000',
    primaryWhatsAppCountryCode: '+91',
    primaryWhatsAppPhone: '9876500000',
    members: [{ name: 'Pending Parent', callCountryCode: '+91', callPhone: '9876500000', whatsappCountryCode: '+91', whatsappPhone: '9876500000' }],
  ...
  pendingEdit: {
    ...
    status: 'Active',
    primaryMobile: '+91 9876511111',
    primaryCallCountryCode: '+91',
    primaryCallPhone: '9876511111',
    primaryWhatsAppCountryCode: '+91',
    primaryWhatsAppPhone: '9876511111',
    currentAddress: 'Old Address',
    members: [{ name: 'Edited Parent', callCountryCode: '+91', callPhone: '9876511111', whatsappCountryCode: '+91', whatsappPhone: '9876511111', tags: ['Choir'] }],
    isPendingCreation: false,
    hasPendingEdit: true,
    draftData: {
      ...
      primaryCallCountryCode: '+91',
      primaryCallPhone: '9876522222',
      primaryWhatsAppCountryCode: '+91',
      primaryWhatsAppPhone: '9876522223',
      members: [{ name: 'Edited Parent', callCountryCode: '+91', callPhone: '9876522222', whatsappCountryCode: '+91', whatsappPhone: '9876522223', tags: ['Choir', 'Youth Meeting'] }],
    },
