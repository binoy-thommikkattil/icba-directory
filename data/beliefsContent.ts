export const assemblyIntro = "We are a congregation of Bible-based believers, gathering together in the name of the Lord Jesus Christ. We are a local, independent Assembly under the headship and authority of Christ. We meet in our Saviour's precious name for corporate worship, fellowship, prayer, and study of the Bible.";
