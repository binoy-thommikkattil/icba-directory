        ...
        <div className="min-h-screen bg-slate-50 p-6 pb-24">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200 mb-6 flex items-center gap-4">
                    <div className="shrink-0 w-14 h-14 bg-sky-50 text-sky-600 font-bold text-xl rounded-xl border border-sky-100 flex items-center justify-center">
                        {song.songNumber || '#'}
                    </div>
                    <div className="flex-1">
                        <h1 className="text-xl md:text-2xl font-serif font-bold text-slate-900 leading-tight mb-1">{song.title}</h1>
