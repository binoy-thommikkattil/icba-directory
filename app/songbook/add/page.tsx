...
export default function AddSongPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        if (!title || !songNumber) return alert("Title and Song Number are required.");
        ...
        try {
            ...
            // 2. HANDLE TEXT UPLOAD (Only run AI if it's not already English)
    ...
    return (
        <div className="min-h-screen bg-slate-50 p-6 pb-24">
            <div className="max-w-2xl mx-auto">
                ...
                <p className="text-slate-500 text-sm mb-8">Add a song to the assembly library.</p>
                ...
                <form onSubmit={handleSubmit} className="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="col-span-2 sm:col-span-1">
                            ...
                            <input required type="number" className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-sky-500 transition" value={songNumber} onChange={e => setSongNumber(e.target.value)} placeholder="e.g. 42" />
                        </div>
                        <div className="col-span-2 sm:col-span-1">
